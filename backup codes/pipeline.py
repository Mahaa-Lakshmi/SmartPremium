...
# Load data
data = pd.read_csv("/content/drive/MyDrive/GUVI Capstone projects/Project3/Model Building/train.csv")
data, scaler, encoders, income_lambda, premium_lambda = preprocess_data(data)

# Save preprocess objects
pickle.dump(scaler, open("/content/drive/MyDrive/GUVI Capstone projects/Project3/Model Building/scaler.pkl", "wb"))
pickle.dump(encoders, open("/content/drive/MyDrive/GUVI Capstone projects/Project3/Model Building/label_encoders.pkl", "wb"))
pickle.dump((income_lambda, premium_lambda), open("/content/drive/MyDrive/GUVI Capstone projects/Project3/Model Building/boxcox_lambdas.pkl", "wb"))
...
models["XGBoost tuned"] = XGBRegressor(**xgb_optimizer.max["params"], random_state=42, n_jobs=-1)
...
models["Random Forest tuned"] = RandomForestRegressor(**rf_optimizer.max["params"], random_state=42, n_jobs=-1)
...
# Save best model
pickle.dump(best_model, open("/content/drive/MyDrive/GUVI Capstone projects/Project3/Model Building/best_model.pkl", "wb"))
